...
class sub_convert():
    ...
    def convert(raw_input, input_type='url', output_type='url', custom_set={'dup_rm_enabled': False, 'format_name_enabled': True}): # {'input_type': ['url', 'content'],'output_type': ['url', 'YAML', 'Base64']}
    ...
    def makeup(input, dup_rm_enabled=False, format_name_enabled=True): # 对节点进行区域的筛选和重命名，输出 YAML 文本 
